...
packs <- c("knitr", "tidyverse", "lubridate", "openair", "stringr")
...
# carregar os metadados (rds com coordenadase nomes das EMA)
tar_info <- readRDS("..//info_inmet_sul_2000_2016.rds") %>%
...
saveRDS(tar_summary_4y, file = file.path("../output/derived_data", tar_summary_file))
```
