...
```{r}
# Definições iniciais
ID <- '1b' # identificador do teste de controle de qualidade aplicado
...
records_emc <- temp_records_inmet(
  file_tmx = "../data-raw/Temperatura-Maxima-Absoluta_NCB_1961-1990.xls",
...
filter(var1_data_qc, tavg_qc1b == 1) %>% arrange(site)
```
...
## var1_nr_susp <- var1_data_qc %>% filter(tavg_qc1b == 1) %>% nrow()
